    ...
    if (sliders.length === 0) {
      const defaultSliders = [
        ...
        },
        {
          ...
          subtitle: "যুক্তরাজ্য, ইউএসএ,加拿大 ও ইউরোপের সেরা বিশ্ববিদ্যালয়সমূহে ভর্তির আবেদন করুন। স্কলারশিপ ও ভিসা গাইডের সম্পূর্ণ দায়িত্ব আমাদের।",
      ...
      const defaultPackages = [
        {
          ...
          price: 28500,
          description: "কাঠমান্ডু এবং পোখরা শহরের নয়নাবিরাম প্রাকৃতিক দৃশ্য এবং হিমালয়ের চূড়া দেখার অপূর্ব সুযোগ। গাইড ও হোটেলসহ সম্পূর্ণ সার্ভিস।",
          imageUrl: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&q=80&w=800",
          itinerary: ["১ম দিন: কাঠমান্ডু আগমন ও হোটেল ট্রান্সফার", "২য় দিন: স্বয়ম্ভূনাথ এবং দরবার স্কয়ার পরিদর্শন", "৩য় দিন: পোখরা যাত্রা ও ফেওয়া লেকে নৌকা ভ্রমণ", "৪র্থ দিন: সারেংকোট থেকে সূর্যোদয় দর্শন", "৫ম দিন: বিদায় ও ঢাকা প্রত্যাবর্তন"],
        },
        {
          ...
          price: 42000,
          description: "কলম্বো, ক্যান্ডি এবং সিগিরিয়ার ঐতিহাসিক লায়ন রক ঘুরে দেখার অপূর্ব সুযোগ। বৌদ্ধ ঐতিহ্য এবং সমুদ্র সৈকতের সমন্বয়।",
          imageUrl: "https://images.unsplash.com/photo-1588598126749-db37f698c9f5?auto=format&fit=crop&q=80&w=800",
          itinerary: ["১ম দিন: কলম্বো আগমন ও ক্যান্ডি যাত্রা", "২য় দিন: টুথ রিলিক টেম্পল ও রয়্যাল বোটানিক্যাল গার্ডেন", "৩য় দিন: সিগিরিয়া কেল্লা আরোহণ", "৪র্থ দিন: নুয়ারা এলিয়া চা বাগান পরিদর্শন", "৫ম দিন: কলম্বো সিটি ট্যুর ও শপিং", "৬ষ্ঠ দিন: ঢাকা প্রত্যাবর্তন"],
        },
        {
          ...
          price: 9500,
          description: "করমজল, হারবাড়িয়া ও কটকার গভীর জঙ্গল ঘুরে বেঙ্গল টাইগারের পদচিহ্ন ও চিত্রা হরিণ দেখার রোমাঞ্চকর বোট ট্যুর।",
          imageUrl: "https://images.unsplash.com/photo-1589952283406-b53a7d1347e8?auto=format&fit=crop&q=80&w=800",
          itinerary: ["১ম দিন: মংলা ঘাট থেকে বোটে চড়ে করমজল ও হাড়বাড়িয়া ভ্রমণ", "২য় দিন: কটকা ওয়াচ টাওয়ার ও জামতলা সমুদ্র সৈকত ট্র্যাকিং", "৩য় দিন: করমজল অভয়ারণ্য এবং মংলা প্রত্যাবর্তন"],
        },
      ];
      ...
      const defaultCirculars = [
        {
          ...
          requirements: ["ন্যূনতম ২ বছরের বাস্তব অভিজ্ঞতা", "ইংরেজি ভাষায় সাধারণ কথোপকথনের দক্ষতা", "বয়স ২০ থেকে ৪৫ বছরের মধ্যে হতে হবে"],
      ...
      const defaultReviews = [
        {
          ...
          reviewText: "এমসিইএস প্ল্যাটফর্মের মাধ্যমে আমি রোমানিয়াতে কাজের ভিসা পেয়েছি। তাদের প্রসেসিং খুবই স্বচ্ছ এবং দ্রুত ছিল। ধন্যবাদ পুরো টিমকে!",
          rating: 5,
      ...
      const defaultBlogs = [
        {
          ...
          content: "জাপানে বর্তমানে কেয়ারগিভার, এগ্রিকালচার এবং কনস্ট্রাকশনে অনেক দক্ষ শ্রমিকের প্রয়োজন।...",
